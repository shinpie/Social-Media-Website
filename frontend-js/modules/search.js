...
export default class Search {
    //1. seleesct dom elemnts and keep track of any useful data
    constructor() {
    ...
    keyPressHandler() {
        ...
        if (value != "" && value != this.previousValue) {
            ...
            this.showLoaderIcon()
            this.hideResultsArea()
            //this.typingWaitTimer = setTimeout(() => this.sendRequest(), 300)
    ...
    renderResultsHTML(posts) {
        if(posts.length) {
            ...
            this.resultsArea.innerHTML = `<p class="alert alert-danger text-center shadow-sm">Sorry, we could not find any search results for that search.</p>`
        }
        this.hideLoaderIcon()
